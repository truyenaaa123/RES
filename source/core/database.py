...
class Database():
    ...
    def create_champion_by_cost(self):
        ...
        list_cham[1].append(Champion("Maokai", {"Shadowisles":True, "Bastion":True}, 1))
        list_cham[1].append(Champion("Orianna", {"Piltover":True, "Sorcerer":True}, 1))
        list_cham[1].append(Champion("Poppy", {"Yordle":True, "Demacia":True, "Bastion":True}, 1))
        ...
        list_cham[1].append(Champion("Viego", {"Shadowisles":True, "Rogue":True}, 1))
        ...
        list_cham[2].append(Champion("Swain", {"Noxus":True, "Strategist":True, "Sorcerer":True}, 2))
        list_cham[2].append(Champion("Taliyah", {"Shurima":True, "Multicaster":True}, 2))
        list_cham[2].append(Champion("Teemo", {"Yordle":True, "Strategist":True, "Multicaster":True}, 2))
        list_cham[2].append(Champion("Vi", {"Piltover":True, "Bruiser":True}, 2))
        list_cham[2].append(Champion("Warwick", {"Zaun":True, "Juggernaut":True, "Challenger":True}, 2))
        ...
        list_cham[3].append(Champion("Kalista", {"Shadowisles":True, "Challenger":True}, 3))
        ...
        list_cham[3].append(Champion("Taric", {"Targon":True, "Bastion":True, "Sorcerer":True}, 3))
        ...
        list_cham[4].append(Champion("Gwen", {"Shadowisles":True, "Slayer":True}, 4))
        ...
        list_cham[5].append(Champion("Aatrox", {"Darkin":True, "Slayer":True, "Juggernaut":True}, 5))
        list_cham[5].append(Champion("Ahri", {"Ionia":True, "Sorcerer":True}, 5))
        list_cham[5].append(Champion("Belveth", {"Empress":True, "Void":True}, 5))
        list_cham[5].append(Champion("Heimerdinger", {"Piltover":True, "Yordle":True, "Technogenius":True}, 5))
        ...
        list_cham[5].append(Champion("Senna", {"Shadowisles":True, "Gunner":True, "Redeemer":True}, 5))
